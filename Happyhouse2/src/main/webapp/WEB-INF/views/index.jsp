...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=AIzaSyATnhiEf1hTHVZTZtvSL_dC_BpC6PmQdkQ"></script>
			...
			<div>
				<nav class="navbar navbar-expand-sm bg-light">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link"
							href="./modiuser">회원정보 변경</a></li>
						<li class="nav-item"><a class="nav-link"
							href="#">회원탈퇴</a></li>
						<li class="nav-item"><a class="nav-link"
							href="#">회원정보 검색(회원정보 리스트)</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./houselistAt">주택 거래 목록</a></li>
							<li class="nav-item">
							<a class="nav-link"
							href="http://localhost:9999/happyhouse/">QnA</a></li>
					</ul>
				</nav>
				<br>
...
<!-- 		<footer class="col-ms-12 bg-dark rounded mt-1"></footer> -->
				...
				<script async defer
					src="https://maps.googleapis.com/maps/api/js?key=AIzaSyATnhiEf1hTHVZTZtvSL_dC_BpC6PmQdkQ&callback=initMap">
...
function geocode(jsonData) {
	...
	$.each(jsonData, function(index, vo) {
		...
		$.get("https://maps.googleapis.com/maps/api/geocode/json"
				,{	key:'AIzaSyATnhiEf1hTHVZTZtvSL_dC_BpC6PmQdkQ'
