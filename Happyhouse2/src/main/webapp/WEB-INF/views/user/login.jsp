...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=8940d7dfdaa8e8db4c0f4d73dd782a21"></script>
<script type="text/javascript">
function login() {
	if(document.getElementById("userid").value == "") {
		...
		document.getElementById("loginform").action = "/happyhouse/loginAf";
		document.getElementById("loginform").submit();
	}
}
	 
function moveJoin() {
	document.location.href = "/happyhouse/loginAf";
}	
function movePWSearch(){
	document.location.href = "${root}/loginAf";
}
</script>
</head>
<body>
	...
	<div class="col-lg-6" align="center">
		...
		<input type="hidden" name="act" id="act" value="login">
			...
			<div class="form-group" align="center">
				...
				<button type="button" class="btn btn-primary" onclick="javascript:movePWSearch();">비밀번호 찾기</button>
			</div>
		</form>
	</div>
</div>
